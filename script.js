...
forms.addEventListener('submit',function(event){
    ...
    if(formTitle.length>8 || formTitle== ''){
        errors.title = 'Title can not be empty and not more than 8 symbols';
    } 

    let formDescription = document.getElementById('body').value;
    if(formDescription.length>200 || formDescription== ''){
        errors.description = 'Description can not be empty and cannot be more than 200 symbols';
    }
